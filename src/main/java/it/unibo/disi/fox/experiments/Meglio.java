...
public class Meglio {
	...
	static String dbpediaSparqlEndpoint = "https://dbpedia.org/sparql";
		...
		//lo uso perchè è un file più piccolo 
		String inputFile = config.getString("fileDaLeggere");
						...
						try (BufferedReader br = new BufferedReader(new FileReader(nomeFile))) {
							...
							for(int i=0;i<instances2.numAttributes();i++) {
					            ...
					            while ((line = br.readLine()) != null) {
									...
									//lo pulisco tutte le volte
									//for(int w=0; w<rigaCompleta.length; w++) {
									//	rigaCompleta[w]= "0";
									//}
									...
									//vanno aggiunte le altre feauters
									...
									//stampo per vedere se è corretto
									for (int j=0; j<rigaCompleta.length;j++) {
										rigaPerFile = rigaPerFile + rigaCompleta[j] + "\t";
										logger.info("array " + rigaCompleta[j]);
										//logger.info("stringa " + rigaPerFile);
									}
