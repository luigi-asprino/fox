		...
		try {
			...
			try (BufferedReader br = new BufferedReader(new FileReader(nomeFile))) {
				...
				while ((line = br.readLine()) != null) {
					 ...
					 * 
					 * 
					 * double classe = svm.classifyInstance(si); System.out.println("classe");
					 * 
					 * //associare il double all'etichetta String nomeClasse = instances.classAttribute().value((int) classe);
					 * 
					 * 
					 * //scrittura risultati su file TSV (uriEntita, nomeClasse) FATTO FileWriter fileWriter = new FileWriter("/Users/serenapasserini/eclipse-workspace/fox/classificazione.tsv"); printWriter = new PrintWriter(fileWriter); printWriter.print(FILE_HEADER);
					 * 
					 * //per scrivere printWriter.print(uriEntity + "\t" + nomeClasse +"\n");
					 * 
					 * printWriter.close();
					 */
